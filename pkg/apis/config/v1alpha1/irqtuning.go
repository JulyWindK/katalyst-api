...
type IRQCoresIncConfig struct {
	...
	FullScaleFactor *float64 `json:"fullScaleFactor"`
...
type IRQCoresDecConfig struct {
	...
	// Max cores to decrease each time, default 1
	// +kubebuilder:default=1
